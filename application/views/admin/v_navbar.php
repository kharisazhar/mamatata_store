...
<body class="animsition">
    <div class="page-wrapper">
            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        ...
                        <img src="<?php echo base_url(),'assets/images/icons/logo.png'?>" alt="MamatataLogo" width="200" height="200">
                        </a>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="far fa-tachometer-alt"></i>Dashboard</a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                <img src="<?php echo base_url(),'assets/images/icons/logo.png'?>" alt="MamatataLogo" width="150" height="150">
                </a>
            </div>
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="has-sub active">
                            <a href="<?php echo base_url('admin/dashboard') ?>">
                                <i class="fas fa-tachometer-alt"></i>Add Product
                            </a>
                        </li>
